...
Converts Saki AOI (Automated Optical Inspection) XML result files to WATS UUT reports.
...
Saki Corporation manufactures automated optical inspection and 3D inspection systems for PCB assembly. This converter imports Saki AOI XML inspection results into WATS.
...
The recommended installation method is via the installer. Download the latest release from the [Releases](https://github.com/Virinco/WATS-Converter-Saki-AOI/releases/latest) page.

## Installation

### Using the Installer (Recommended)
1. Download the installer (`.exe`) from the [Releases](https://github.com/Virinco/WATS-Converter-Saki-AOI/releases/latest) page.
...
1. Download the `.dll` file from the [Releases](https://github.com/Virinco/WATS-Converter-Saki-AOI/releases/latest) page.
...
## Resources
- [GitHub Repository](https://github.com/Virinco/WATS-Converter-Saki-AOI)
- [Saki 3D AOI systems](https://www.sakicorp.com/en/product/3d-aoi/?cat=smt)
